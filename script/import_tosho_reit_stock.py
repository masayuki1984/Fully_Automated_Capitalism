...
TABLE = 'tosho_reit_stock_prices'
CSV_FILE_DIR = BASE_DIR + "/../data/tosho_reit_stock_prices/"

args = sys.argv

def get_stock_exchange_code(stock_exchange_name):
    if stock_exchange_name == '東証':
        return 13
    else:
        return 'null'
...
if __name__ == '__main__':
    ...
    file_name = 'tosho-reit-stock-prices_' + file_name_date_part + '.csv'
    ...
    with open (CSV_FILE_DIR + file_name) as csvfile:
        ...
        try:
            ...
            for row in reader:
                ...
                reit_name = row[1] if row[1] != '-' else 'null'
                ...
                query = '''INSERT INTO %s.%s (security_code, dt, reit_name, 
                                ...
                                ''' % (
                    DB_DATABASE, TABLE, security_code, dt, reit_name, stock_exchange_code, industry_type,
